...
const ProductList = ({ title }) => {
    ...
    useEffect(() => {
        const fetchProducts = async (page) => {
            try {
                const response = await axios.get(`https://cyberducky-gtbsaceffbhthhc5.eastus-01.azurewebsites.net/api/products/type?page=${page}&pageSize=12&idtype=1`);
    ...
    return (
        <section className="my-4">
            <div className="product-list-container">
                <h2 className="text-center mb-4">DECAL LAPTOP</h2>
